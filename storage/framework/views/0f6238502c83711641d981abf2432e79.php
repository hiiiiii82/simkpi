...
<title><?php echo $__env->yieldContent('title','Dashboard'); ?> | SIMKPI PLN UP3 Surakarta</title>
...
<nav id="sb">
  ...
  <div style="flex:1">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="sb-link <?php echo e(request()->routeIs('dashboard') ? 'active':''); ?>">
      <i class="bi bi-grid-fill"></i> Dashboard
    </a>

    <div class="sb-sec">Data ULP</div>
    
    <?php $ulpList = \App\Models\Ulp::where('is_active',true)->get(); ?>
    <?php $__currentLoopData = $ulpList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <a href="<?php echo e(route('ulp.show', $u->id)); ?>" class="sb-link <?php echo e(request()->routeIs('ulp.show') && request()->route('id')==$u->id ? 'active':''); ?>"
       style="font-size:12px;padding:6px 18px">
      <i class="bi bi-building"></i> <?php echo e($u->nama); ?>
    ...
    <a href="<?php echo e(route('kpi.index')); ?>" class="sb-link <?php echo e(request()->routeIs('kpi.*') ? 'active':''); ?>">
      <i class="bi bi-list-check"></i> Indikator KPI
    </a>
    <a href="<?php echo e(route('ulp.index')); ?>" class="sb-link <?php echo e(request()->routeIs('ulp.index') ? 'active':''); ?>">
      <i class="bi bi-diagram-3-fill"></i> Kelola ULP
    </a>
    <?php $nWait = \App\Models\Realisasi::where('status','submitted')->count(); ?>
    <a href="<?php echo e(route('validasi.index')); ?>" class="sb-link <?php echo e(request()->routeIs('validasi.*') ? 'active':''); ?>">
      <i class="bi bi-shield-check"></i> Validasi Data
      <?php if($nWait > 0): ?><span class="sb-badge"><?php echo e($nWait); ?></span><?php endif; ?>
    </a>
    <?php endif; ?>

    <div class="sb-sec">Kinerja</div>
    <a href="<?php echo e(route('input.index')); ?>" class="sb-link <?php echo e(request()->routeIs('input.*') ? 'active':''); ?>">
      <i class="bi bi-pencil-square"></i> Input Data
    </a>
    <a href="<?php echo e(route('monitoring.index')); ?>" class="sb-link <?php echo e(request()->routeIs('monitoring.*') ? 'active':''); ?>">
      <i class="bi bi-activity"></i> Monitoring Real-time
    </a>
    <a href="<?php echo e(route('evaluasi.index')); ?>" class="sb-link <?php echo e(request()->routeIs('evaluasi.*') ? 'active':''); ?>">
      <i class="bi bi-clipboard2-data-fill"></i> Evaluasi Kinerja
    </a>

    <div class="sb-sec">Laporan</div>
    <a href="<?php echo e(route('laporan.index')); ?>" class="sb-link <?php echo e(request()->routeIs('laporan.*') ? 'active':''); ?>">
      <i class="bi bi-file-earmark-bar-graph-fill"></i> Laporan & Unduh
    </a>

    <?php if(auth()->user()->isAdmin()): ?>
    <div class="sb-sec">Admin</div>
    <a href="<?php echo e(route('pengguna.index')); ?>" class="sb-link <?php echo e(request()->routeIs('pengguna.*') ? 'active':''); ?>">
  ...
  <div class="sb-foot">
    <div class="sb-av"><?php echo e(auth()->user()->inisial); ?></div>
    <div>
      <div class="sb-uname"><?php echo e(Str::limit(auth()->user()->name,16)); ?></div>
      <div class="sb-urole"><?php echo e(auth()->user()->role_label); ?></div>
    </div>
    <form action="<?php echo e(route('logout')); ?>" method="POST" class="ms-auto">
      <?php echo csrf_field(); ?>
...
<header id="tb">
  <div class="d-flex align-items-center gap-3">
    ...
    <div class="tb-title"><i class="bi bi-lightning-charge-fill" style="color:var(--gold)"></i> <?php echo $__env->yieldContent('page-title','Dashboard'); ?></div>
  </div>
  <div class="tb-right">
    <span class="live"></span>
    <span class="tb-clock" id="clk">—</span>
    <a href="<?php echo e(route('profil')); ?>" class="tb-av"><?php echo e(auth()->user()->inisial); ?></a>
  </div>
</header>
...
<main id="main">
  ...
  <div class="pg"><?php echo $__env->yieldContent('content'); ?></div>
</main>
...
</html><?php /**PATH C:\Users\Asus\Documents\simkpi\resources\views/layouts/app.blade.php ENDPATH**/ ?>